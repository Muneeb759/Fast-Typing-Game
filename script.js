...
const settingsDiff = document.getElementById('difficulty');
...
settingsDiff.value = localStorage.getItem('difficulty') !== null ? localStorage.getItem('difficulty') : 'easy';
...
// 1. To generate a word at random from wordList
...
text.addEventListener('input', (e)=>{
    ...
    //check if user input matches number
    if(typedText === randomWord) {
        ...
        // clear and change the input field
        e.target.value =''
...
// when changing the difficulty settings
